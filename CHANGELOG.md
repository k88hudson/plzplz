...
- add linux musl targets ([#18](https://github.com/k88hudson/plzplz/pull/18))
...
- added hide flag for hiding tasks
- run supports an array of commands
- added depends

### Other

- update cheatsheet with new examples
...
- another attempt to fix pypi

## [0.0.9](https://github.com/k88hudson/plzplz/compare/v0.0.8...v0.0.9) - 2026-02-25
...
## [0.0.8](https://github.com/k88hudson/plzplz/compare/v0.0.7...v0.0.8) - 2026-02-25
